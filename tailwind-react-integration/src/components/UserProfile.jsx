function UserProfile() {
  return (
    <div className="user-profile bg-gray-100 p-4 my-20 sm:p-4 md:p-8 max-w-xs sm:max-w-xs md:max-w-sm rounded-lg shadow-lg text-center hover:shadow-xl transition-shadow duration-300 ease-in-out">
      <img
